...
// Proteksi halaman, pastikan hanya petani yang bisa masuk
...
// Ambil semua data transaksi pembelian milik petani yang sedang login
...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Poppins', sans-serif; }
        ...
        /* Header Style (Kembar dengan Distributor) */
...
<body>
    ...
    <div class="header">
        <div>
            ...
            <h1 style="margin-top: 10px;">Transaction <span style="color: #F4C430;">Logistics.</span></h1>
        </div>
        <div style="text-align: right;">
            <p style="font-size: 12px; font-weight: 800; color: #999; letter-spacing: 1px;">SPRINT 10 // FARMER VIEW</p>
        </div>
    </div>
        ...
        <table>
            ...
            <tbody>
                ...
                if (mysqli_num_rows($query_transaksi) == 0) : 
                    echo "<tr><td colspan='6' style='text-align:center; padding: 50px; color: #a0aec0; font-weight: 700;'>Belum ada riwayat transaksi logistik pengiriman.</td></tr>";
                else :
                ...
                <tr>
                    ...
                    <td style="font-weight: 600;"><i class="fa-solid fa-seedling" style="color: var(--primary); margin-right: 5px;"></i> <?= $row['nama_hasil'] ?></td>
